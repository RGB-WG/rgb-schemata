...
fn main() {
    ...
    let contract = Rgb20::testnet::<NonInflatableAsset<Dumb>>("ssi:anonymous","TEST", "Test asset", None, Precision::CentiMicro)
    ...
    let contract = stock.contract_iface_class::<Rgb20<_>>(contract_id).unwrap();
